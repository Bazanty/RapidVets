        ...
        <div className="mx-auto max-w-6xl px-4 pt-24 pb-10 sm:pb-12">
          ...
          >
            ...
            <Image
              ...
              priority
            />
            <div className="pointer-events-none absolute inset-0 bg-gradient-to-t from-slate-900/45 via-transparent to-transparent mix-blend-multiply" />
            <div className="absolute bottom-0 left-0 right-0 p-6 sm:p-8">
              ...
              <h1 className="mt-3 text-2xl font-semibold tracking-tight text-white drop-shadow-sm sm:text-3xl lg:text-4xl">
                Book a Private Vet Consultation
              </h1>
              <p className="mt-2 max-w-xl text-xs text-slate-100 sm:text-sm">
                From routine check-ups to urgent concerns, our vets provide kind,
                clear and thorough care for your pet.
              </p>
            </div>
          </motion.div>
        </div>
      ...
      <section className="mx-auto flex max-w-6xl flex-col items-start gap-12 px-4 py-10 lg:flex-row lg:items-stretch lg:py-16">
        ...
        >
          ...
          <p className="max-w-xl text-sm text-slate-600 sm:text-base">
            Share a few details about your pet and when you’d like to come in.
            Our team will confirm your appointment and guide you on any
          ...
          <div className="grid gap-4 text-sm sm:grid-cols-2">
            <div className="rounded-2xl border border-slate-200 bg-slate-50/80 p-4">
              ...
              <p className="mt-1 text-xs text-slate-500">
                We move slowly and calmly, especially with nervous or rescue pets.
              </p>
            </div>
            <div className="rounded-2xl border border-slate-200 bg-slate-50/80 p-4">
              <p className="text-sm font-semibold">Clear explanations</p>
              <p className="mt-1 text-xs text-slate-500">
                We explain what we&apos;re doing and why, in simple language.
              </p>
            </div>
            <div className="rounded-2xl border border-slate-200 bg-slate-50/80 p-4">
              <p className="text-sm font-semibold">Home & in-clinic visits</p>
              <p className="mt-1 text-xs text-slate-500">
                Choose what works best for your pet and schedule.
              </p>
            </div>
            <div className="rounded-2xl border border-slate-200 bg-slate-50/80 p-4">
              <p className="text-sm font-semibold">WhatsApp follow-up</p>
              <p className="mt-1 text-xs text-slate-500">
                Ask questions after your appointment for extra peace of mind.
              </p>
            </div>
          </div>

          <p className="text-xs text-slate-500">
            ⚠ For life-threatening emergencies, please call us directly instead of
